...
The Virtual Private Gateway is the virtual entity on the VPC side, that allows configuring routing to that gateway. That VPG is attached to the VPN. So the last entity is the VPN connection which brings it all together and establishes the VPN tunnels between your home or office and VPC.
...
![](vpc_routes.png)
As you can see, the last route is "Propagated", and its target is my virtual private gateway.
