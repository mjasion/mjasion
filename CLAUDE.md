...
│   ├── tags/index.astro        # Tags index page (all tags with counts)
│   ├── tags/[tag].astro        # Individual tag page (5+ posts)
...
- `static/_redirects` - Cloudflare Pages redirects (`/blog` -> `/posts/`, `/talks` -> `/about/#presentations`)
